    ...
    <div class="p-6">
        <div class="space-y-4">
            ...
            @php
                ...
                // Limpiar residuos de "Motivo:" o "Descripción:" sueltos en actions
