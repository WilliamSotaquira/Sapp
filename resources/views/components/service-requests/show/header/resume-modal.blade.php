...
<div id="resume-modal-{{ $serviceRequest->id }}"
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <button type="button"
                    onclick="document.getElementById('resume-modal-{{ $serviceRequest->id }}').classList.add('hidden')"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('keydown', function(e) {
        if (e.key === 'Escape') {
            const modals = document.querySelectorAll('[id^="resume-modal-"]');
    ...
    document.addEventListener('click', function(e) {
        if (e.target.matches('[id^="resume-modal-"]')) {
