...
<div id="start-modal-{{ $serviceRequest->id }}"
     ...
     aria-modal="true"
     aria-hidden="true"
     aria-labelledby="start-modal-title-{{ $serviceRequest->id }}"
     tabindex="-1">
    <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
        ...
        <div class="flex justify-between items-center mb-4">
            <div class="flex items-center">
                ...
                <h3 id="start-modal-title-{{ $serviceRequest->id }}" class="text-lg font-medium text-gray-900">
                    Iniciar Servicio
                </h3>
            </div>
            <button type="button"
                     onclick="closeModal('start-modal-{{ $serviceRequest->id }}')"
