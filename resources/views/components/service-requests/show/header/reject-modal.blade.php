{{-- resources/views/components/service-requests/show/header/reject-modal.blade.php --}}
<div class="inline">
    <!-- Botón para abrir modal -->
    <button type="button"
            onclick="document.getElementById('reject-modal-{{ $serviceRequest->id }}').classList.remove('hidden')"
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <textarea name="rejection_reason"
                                ...
                                required
                                minlength="10">{{ old('rejection_reason') }}</textarea>
                        <p class="mt-1 text-xs text-gray-500">Mínimo 10 caracteres. Sé específico sobre los motivos del rechazo.</p>
                    </div>
                </div>
