...
<div id="closeModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div class="mt-3 text-center">
            ...
            <p class="text-sm text-gray-500 mt-2">¿Está seguro de cerrar esta solicitud?</p>

            <form action="{{ route('service-requests.close', $request) }}" method="POST" class="mt-4">
                @csrf
                <div class="mb-4">
                    <label for="closure_notes" class="block text-left text-sm font-medium text-gray-700 mb-1">Notas de cierre:</label>
                    <textarea id="closure_notes" name="closure_notes" rows="3"
                        ...
                        placeholder="Notas adicionales del cierre (opcional)..."></textarea>
                </div>

                <div class="flex justify-end space-x-3 mt-5">
                    <button type="button" onclick="serviceRequestModals.close('close')"
