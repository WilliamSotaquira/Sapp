...
<a href="{{ route('service-requests.index', ['open' => 1]) }}" class="block bg-white rounded-lg shadow border-l-4 border-indigo-500 overflow-hidden hover:shadow-md transition-shadow focus:outline-none focus:ring-2 focus:ring-indigo-300">
