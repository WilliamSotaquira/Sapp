...
<nav class="flex" aria-label="Breadcrumb">
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li class="inline-flex items-center">
            ...
            <a href="{{ route('service-requests.index') }}" class="text-blue-600 hover:text-blue-700">Solicitudes de Servicio</a>
        </li>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ✅ VERIFICAR: Que las evidencias se carguen correctamente
        @if($serviceRequest->evidences && $serviceRequest->evidences->count() > 0)
            console.log('Evidencias cargadas:', {{ $serviceRequest->evidences->count() }});
        @else
