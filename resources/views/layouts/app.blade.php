        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="hidden md:flex space-x-1">
                        ...
                        <div class="dropdown relative">
                            <button class="flex items-center hover:bg-red-700 px-3 py-2 rounded transition-colors duration-200
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                    <a href="{{ route('login') }}" class="hover:bg-red-700 px-3 py-2 rounded transition-colors duration-200">
