...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
        <h1 class="text-lg font-semibold text-slate-900 mb-1">Nuevo departamento</h1>
        <p class="text-sm text-slate-600 mb-6">Crea un departamento para la organización activa.</p>

        <form method="POST" action="{{ route('requester-management.departments.store') }}" class="space-y-4">
            @csrf
            <div>
