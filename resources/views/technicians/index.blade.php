        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-4">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-gray-800 flex items-center">
                    <i class="fas fa-users-cog mr-2 sm:mr-3 text-red-600 text-lg sm:text-xl"></i>
                    Gestión de Técnicos
                </h2>
                <p class="text-gray-600 mt-1 text-sm sm:text-base">Administra el equipo de soporte técnico y desarrollo</p>
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Especialización</th>
