    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    <i class="fas fa-chevron-right text-gray-400 mx-2"></i>
                    <span class="text-gray-500">Editar Contrato</span>
                </div>
            </li>
        </ol>
    </nav>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-blue-600 text-white px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-xl font-bold">Editar Contrato</h2>
                        <p class="text-blue-100 text-sm">Actualice la información del contrato</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                      id="description"
                                      rows="4"
                                      class="w-full border border-gray-300 rounded-md shadow-sm p-3 focus:ring-blue-500 focus:border-blue-500 @error('description') border-red-500 @enderror">{{ old('description', $contract->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1 flex items-center">
                                    <i class="fas fa-exclamation-circle mr-1"></i>{{ $message }}
                                </p>
                        ...
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <label for="is_active" class="flex items-center cursor-pointer">
                                <div class="relative">
                                    ...
                                    <div class="dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition transform {{ old('is_active', $contract->is_active) ? 'translate-x-4 bg-green-500' : '' }}"></div>
                                </div>
                                <div class="ml-3">
